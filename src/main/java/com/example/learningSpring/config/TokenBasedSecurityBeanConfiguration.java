...
public class TokenBasedSecurityBeanConfiguration {

    private final UserMyBatisRepository userRepository;

    @Bean
    public UserDetailsService userDetailsService() {
        return username -> userRepository.findByUsername(username).orElseThrow(()-> new UsernameNotFoundException("user not found in db."));
    }
